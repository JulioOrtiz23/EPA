            ...
            <div class="card mt-5 pb-3">
                <div class="card-body">
                    <div class="form-group">
                        <a class="btn btn-primary mt-3 mb-5" href="<?php echo base_url; ?>ReporteProductos/generarPdfE"><i class="fas fa-file-pdf"></i> Imprimir Reporte</a>
                    </div>
                    <table class="table table-light table-hover table-sm" id="tblEntrega">
