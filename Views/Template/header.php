    ...
    <header class="header-area header-sticky">
        <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light space">
                ...
                <div class="collapse navbar-collapse menu-right" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-5 mr-auto">
                        ...
                        <?php } else { ?>
                            <li class="nav-item dropdown">
                                <a class="dropdown-toggle btn btn-light" role="button" data-toggle="dropdown" id="dropdownMenuButton" aria-haspopup="true" aria-expanded="false">
                                    Productos
                                </a>
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton"
                                    onclick="javascript:console.log( $(event.target).data('mode'))">
                                    <a class="dropdown-item" href="<?php echo base_url; ?>AgregarProducto"
                                        data-mode="mode1" data-dir="/home">Ingreso de producto</a>
                                    <a class="dropdown-item " href="<?php echo base_url; ?>SalidaProducto"
                                        data-mode="mode2" data-dir="/foo">Salida de produccto</a>
                                    <a class="dropdown-item " href="<?php echo base_url; ?>Categoria" data-mode="mode3"
                                        data-dir="/bar">Categoria</a>
                                    <a class="dropdown-item " href="<?php echo base_url; ?>Marca" data-mode="mode4"
                                        data-dir="/">Marca</a>
                                </div>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton"
                                    onclick="javascript:console.log( $(event.target).data('mode'))">
                                    <a class="dropdown-item" href="<?php echo base_url; ?>ReporteProductos/ingresos" data-mode="mode1"
                                        data-dir="/home">Reporte de Ingreso</a>
                                    <a class="dropdown-item " href="<?php echo base_url; ?>ReporteProductos/entregas" data-mode="mode2"
                                        data-dir="/foo">Reporte de salida</a>
                                    <a class="dropdown-item " href="<?php echo base_url; ?>ReporteProductos/productos" data-mode="mode3"
                                        data-dir="/foo">Reporte de Productos</a>
                                </div>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item text-danger" href="<?php echo base_url; ?>Login/salir"
                                        class="d-block"><i class="fas fa-sign-out-alt"></i> Salir</a>
                                </div>
                            </li>
                        <?php } ?>
                    </ul>
